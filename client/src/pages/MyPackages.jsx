    ...
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
      <div className="flex justify-between items-center mb-8">
        ...
        <button
          ...
          className="flex items-center space-x-2 bg-primary-600 hover:bg-primary-700 text-white px-6 py-3 rounded-lg font-medium transition"
        >
      ...
      {isLoading ? (
        ...
        <div className="text-center py-12 bg-white rounded-lg shadow-md">
          ...
          <button
            onClick={() => setShowForm(true)}
            className="inline-flex items-center space-x-2 bg-primary-600 hover:bg-primary-700 text-white px-6 py-3 rounded-lg font-medium transition"
          >
            <Plus className="h-5 w-5" />
                ...
                <div className="flex-1 p-6">
                  ...
                  <div className="flex space-x-3">
                    <button
                      ...
                      className="flex items-center space-x-1 bg-blue-600 hover:bg-blue-700 text-white px-4 py-2 rounded-md text-sm font-medium transition"
                    >
